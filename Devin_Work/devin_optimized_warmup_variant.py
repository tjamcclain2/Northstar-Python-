...
def _run_pipeline_once(
    ...
    """Runs generate -> generate -> compare exactly once, with no timing and
    no printing beyond what the called functions already print. Shared by
    the warmup pass and the timed pass below so the two are guaranteed to
    exercise identical code paths/shapes."""
