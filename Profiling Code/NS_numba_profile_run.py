...
def main():
    ...
    hanford_detector_angles = np.array([(46+27/60+18.528/3600)*np.pi/180, (240+35/60+32.4343/3600)*np.pi/180,np.pi/2+125.9994*np.pi/180])
    livingston_detector_angles = np.array([(30+33/60+46.4196/3600)*np.pi/180, (269+13/60+32.7346/3600)*np.pi/180,np.pi/2+197.7165*np.pi/180])
...
if __name__ == "__main__":
    import cProfile
    cProfile.run('main()', filename='numba_profile.prof')
